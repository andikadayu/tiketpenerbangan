    ...
    <div class="limiter">
        <div class="container-login100">
            <div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-50">
                <form id="frmLogin" action="{{ url()->current() . '/process' }}" method="POST" class="login100-form validate-form" autocomplete="off">
                    {{ csrf_field() }}
                    ...
                    <div class="text-center p-t-45 p-b-4">
                        ...
                        <a href="{{ url('register') }}" class="txt2 hov1" style="text-decoration: none;">
                            Daftar
                        </a>
                    </div>
                </form>
